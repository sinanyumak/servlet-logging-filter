...
public class PrintWriterLoggingFilterTest {
    ...
    void testDoFilter_Full() throws Exception {
        ...
        verify(logger).debug(getMarker("RESPONSE"), "RESPONSE: {\"status\":200,\"headers\":{\"Content-Type\":\"text/plain\"},\"body\":\"Test response body from print writer\"}");
    }
    ...
    private static class TestFilter implements Filter {
        ...
        public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
            response.getWriter().write("Test response body from print writer");
        }
